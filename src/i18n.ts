...
const en = {
  ...
  teapotProtocol: 'HIDDEN PROTOCOL // INDEX',
  teapotTitle: "I'm a teapot",
  teapotBody: 'The server refuses to brew coffee with a teapot. It does, however, run an arcade.',
  teapotPlayStack: 'Play Stack',
  teapotPlayHeaderfall: 'Play Headerfall',
  teapotBackToWork: 'Back to work (503 Fun Unavailable)',
...
const de: Record<Keys, string> = {
  ...
  headerfallPause: 'PAUSE',
  teapotProtocol: 'VERSTECKTES PROTOKOLL // INDEX',
  teapotTitle: 'Ich bin eine Teekanne',
  teapotBody: 'Der Server weigert sich, mit einer Teekanne Kaffee zu kochen. Aber er betreibt eine Arcade.',
  teapotPlayStack: 'Stack spielen',
  teapotPlayHeaderfall: 'Headerfall spielen',
  teapotBackToWork: 'Zurück an die Arbeit (503 Fun Unavailable)',
